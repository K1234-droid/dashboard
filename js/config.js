...
export let pinModalPurpose = 'login'; // 'login', 'update', 'disable'
...
export const i18nData = {
    ...
    "settings.security.pinLabel": { id: "Buat/Ubah PIN Prompt Karakter (4 digit)", en: "Create/Change Character Prompt PIN (4 digits)", ja: "キャラクタープロンプトPINの作成/変更（4桁）" },
    ...
    "info.longPath.text": { 
        ...
        ja: "場所が深すぎる（フォルダ名またはパスが長すぎます）ため、ファイルを読み込めませんでした。\n「ファイルを選択」ボタンを使用してこの画像を開いてください。"
    }
};